...
var CalendarComponent = /** @class */ (function () {
    ...
    CalendarComponent.prototype.parseCalendar = function (calendar) {
        var typeOrder = ["holiday", "absence", "assignment", "quiz", "lecture", "discussion", "officehours_ta", "officehours_daniel"];
        ...
        while (calendar_start_date.isBefore(calendar_end_date)) {
            calendar_dates.push({
                ...
                "weekend": calendar_start_date.day() == 0 || calendar_start_date.day() == 6,
                "events": []
            });
            ...
            if (calendar_date.month == eventDate.month() && calendar_date.date == eventDate.date()) {
                ...
                if (event.type in calendar['defaults'] && "place" in calendar['defaults'][event.type]) {
                    ...
                    if (Array.isArray(calendar['defaults'][event.type]["place"])) {
                        ev.places = calendar['defaults'][event.type]["place"].map(function (place) {
                ...
                eventsToPush.forEach(function (e, i) {
                ...
                //Sort events in date
                calendar_dates[calendarI].events.sort(function (a, b) {
